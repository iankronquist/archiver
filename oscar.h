...
#define OSCAR_ALL_OF_IT OSCAR_HDR_END_LEN + OSCAR_HDR_END_LEN + OSCAR_MAX_FILE_NAME_LEN + OSCAR_DATE_SIZE * 3 + OSCAR_UGID_SIZE *2 + OSCAR_MODE_SIZE + 2 + 1 + OSCAR_FILE_SIZE + OSCAR_SHA_DIGEST_LEN
